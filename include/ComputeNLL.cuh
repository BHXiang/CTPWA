...
void computeNll(const cuComplex *d_matrix, const cuComplex *d_vector, const double *d_weights, cuComplex *d_S, double *d_Q, double *d_final_result, int nlength, int ngls, int npolar, double phsp_factor);
